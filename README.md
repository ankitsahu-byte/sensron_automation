...
pytest tests/ui/test_configuration_jetson_device_config_page.py -v -s
pytest tests/ui/test_configuration_log_config_page.py -v -s
pytest tests/ui/test_configuration_temp_monitering_page.py -v -s
